...
% correct, no weekend
% CO2:N_ini=4,N_pred=1,linear4.0865 N_pred=0 4.7531
%       N_ini=4,N_pred=4,linear 3.9977
%       N_ini=10,N_pred=1,linear 4.6480
...
%%
start = 1; last = 5*96;
u44 = y_test(start:last);
u4 = y_test_pred(start:last);
save('./huatu/gp2.mat','u44','u4')
%%
h=figure;
hold on
