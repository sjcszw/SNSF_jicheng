...
% [x_test, y_test] = select_feature_temp(u_cl(:,7*96+1-N_init:end),temp_cl(:,7*96+1-N_init:end),w_cl(:,7*96+1-N_init:end),N_init,N_pred,0);
...
% [x_test, y_test] = select_feature_co2temp(u_cl(:,7*96+1-N_init:end),y_cl(:,7*96+1-N_init:end),temp_cl(:,7*96+1-N_init:end),w_cl(:,7*96+1-N_init:end),N_init,N_pred,0);
%%
% 1:96*4+50;
...
% correct, no weekend
% CO2:N_ini=4,N_pred=1,rbf 3.7141 N_pred=0 4.2032
%       N_ini=4,N_pred=4,rbf  4.0212
%       N_ini=10,N_pred=1,rbf  4.8302
