...
clc
clear
rng(125) % 126: tzero(A,B,C,zeros(ny,nu),eye(nx))>1
%%
% system definition
% A = [1 1; 0 1];
% B = [1; 1];%[0.5; 1]; 
...
% plot( u_pred(num,start:last), 'Color',[0 0.4470 0.7410],'LineWidth',1)
...
legend('u1 real','u1 estimate','FontSize',18) %'Estimation point',
