...
% [U,S,V] = svd(tem3);
% G1 = V*[inv(S(1:9,1:9)) zeros(9,2);zeros(36,11)]*U';
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% ===================== Change according to S
...
UY3 = Hankel_Y(ny*(N_ini-1)+1:ny*(N_ini), :)*pinv([Hankel_U(1:nu*N_ini, :); Hankel_Y(1:ny*(N_ini-1), :);]);
U3 = UY3(:,1:nu*N_ini);
...
save('./u1_p2_1805u0=0.mat','u1_p2','u1_r2');
