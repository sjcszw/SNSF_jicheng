% 18052022 change line 25 for i=1:10; line 55-61, u_cl update
% D ~= 0
clear
for j = 353:353 % 72 281
clc
clearvars -except j
...
if max(abs(eig(U_check)))< 0.95
     max(abs(eig(U_check)))
    if abs(tzero(A,B,C,0*D,eye(nx))) <0.95
        1
    end
end
end
...
G = V*[inv(S(1:15,1:15)) zeros(15,7);zeros(30,22)]*U';
...
G_bar = V*[inv(S(1:15,1:15)) zeros(15,7);zeros(30,22)]*U';
...
save('./u1_p1_1805u0=0.mat','u1_p1','u1_r1');
