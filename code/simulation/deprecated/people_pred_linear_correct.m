...
%%
%linear constant.
% Only CO2:N_ini=4,N_pred=0, ls 4.259 ,robust 4.4210
%       N_ini=4,N_pred=4,ls 4.319
%       N_ini=10,N_pred=0,ls 4.3452
% [CO2; diff]:  N_ini=4,N_pred=0,ls 4.259 no influence due to linear model
%       N_ini=4,N_pred=4,ls 4.319
%       N_ini=10,N_pred=0,ls 4.3452
% [CO2; temperature;power;wea]
%       N_ini=4,N_pred=0,ls 6.3461
%       N_ini=4,N_pred=4,ls 7.3328
%       N_ini=10,N_pred=0,ls 7.9167
% [temperature;power;wea]
%       N_ini=4,N_pred=0,ls 11.47
%       N_ini=4,N_pred=4,ls 12.2817
%       N_ini=10,N_pred=0,ls 12.6068

% correct, no weekend
% CO2:N_ini=4,N_pred=1,linear 5.2397 N_pred=0 5.9944
%       N_ini=4,N_pred=4,linear 4.7600
%       N_ini=10,N_pred=1,linear 5.2961
mdl = fitlm(x_train',y_train','RobustOpts','off');
...
% No weekends
% Only CO2:N_ini=4,N_pred=0, linear  7.0005
%%
%%
start = 1; last = 5*96;
u33 = y_test(start:last);
u3 = y_test_pred(start:last);
save('./huatu/li2.mat','u33','u3')
%%
h=figure;
hold on
